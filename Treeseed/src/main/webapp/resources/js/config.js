...
// lazyload config
  ...
  angular.module('treeSeed').constant('JQ_CONFIG', {
      ...
      plot:           [   'resources/js/libs/jquery/flot/jquery.flot.js',
      ...
      nestable:       [   'resources/js/libs/jquery/nestable/jquery.nestable.js',
      ...
      slider:         [   'resources/js/libs/jquery/bootstrap-slider/bootstrap-slider.js',
                          'resources/js/libs/jquery/bootstrap-slider/bootstrap-slider.css'],
      chosen:         [   'resources/js/libs/jquery/chosen/chosen.jquery.min.js',
                          'resources/js/libs/jquery/chosen/bootstrap-chosen.css'],
      TouchSpin:      [   'resources/js/libs/jquery/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.js',
                          'resources/js/libs/jquery/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.css'],
      wysiwyg:        [   'resources/js/libs/jquery/bootstrap-wysiwyg/bootstrap-wysiwyg.js',
                          'resources/js/libs/jquery/bootstrap-wysiwyg/external/jquery.hotkeys.js'],
      dataTable:      [   'resources/js/libs/jquery/datatables/media/js/jquery.dataTables.min.js',
      ...
      vectorMap:      [   'resources/js/libs/jquery/bower-jvectormap/jquery-jvectormap-1.2.2.min.js', 
      ...
      footable:       [   'resources/js/libs/jquery/footable/dist/footable.all.min.js',
                          'resources/js/libs/jquery/footable/css/footable.core.css'],
      fullcalendar:   [   'resources/js/js/libs/jquery/moment/moment.js',
      ...
      daterangepicker:[   'resources/js/libs/jquery/moment/moment.js',
      ...
      tagsinput:      [   'resources/js/libs/jquery/bootstrap-tagsinput/dist/bootstrap-tagsinput.js',
  ...
  angular.module('treeSeed').constant('MODULE_CONFIG', [    
      ...
      },
      {
          ...
          files: [
            'resources/js/libs/angular/angular-file-upload/angular-file-upload.js'
          ]
      },
      {
          name:'ui.calendar',
      ...
      },
      {
          ...
          files: [
              'resources/js/libs/angular/videogular/videogular.min.js'
          ]
      },
      {
          name: 'com.2fdevs.videogular.plugins.controls',
          files: [
              'resources/js/libs/angular/videogular-controls/controls.min.js'
          ]
      },
      {
          name: 'com.2fdevs.videogular.plugins.buffering',
          files: [
              'resources/js/libs/angular/videogular-buffering/buffering.min.js'
          ]
      },
      {
          name: 'com.2fdevs.videogular.plugins.overlayplay',
          files: [
              'resources/js/libs/angular/videogular-overlay-play/overlay-play.min.js'
          ]
      },
      {
          name: 'com.2fdevs.videogular.plugins.poster',
          files: [
              'resources/js/libs/angular/videogular-poster/poster.min.js'
          ]
      },
      {
          name: 'com.2fdevs.videogular.plugins.imaads',
          files: [
              'resources/js/libs/angular/videogular-ima-ads/ima-ads.min.js'
          ]
      },
      {
          name: 'xeditable',
      ...
      },
      {
          name: 'smart-table',
          files: [
              'resources/js/libs/angular/angular-smart-table/dist/smart-table.min.js'
          ]
      },
      {
          name: 'angular-skycons',
          files: [
              'resources/js/libs/angular/angular-skycons/angular-skycons.js'
          ]
      }
    ]
  )
