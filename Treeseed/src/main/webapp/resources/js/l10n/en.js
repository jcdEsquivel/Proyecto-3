
{
 "MENU-HEADER": {
    ...
    "VALIDATIONS":{
    	 "VAL-NAME": "You must enter the name",
         "VAL-LAST-NAME": "You must enter the lastname",
         "VAL-EMAIL": "You must enter email",
         "VAL-COUNTRY": "You must enter the country",
         "VAL-PASSWORD": "You must enter the password",
         "VAL-EMAIL-FORMAT": "Invalid email format",
         "VAL-CAUSE": "You must enter the cause",
         "VAL-PASSWORD-FORMAT": {
        	 "TITLE":"Password must have:",
        	 "NUMBER":"At least one number",
        	 "LETTER":"At least on letter",
    ...
    "REGISTER-NONPROFIT": {
        ...
        "NAME-MESSAGE": "Nonprofit name already in use"
    ...
    "LOGIN": {
		...
		"SHAREPROFILEFACEBOOK":"Share Profile",
    	"SHAREFACEBOOK":"Share"
       },
   	...
   	"NONPROFIT-PROFILE": {
        ...
        "AMOUNT-IN":"Amount in: ",
        "AMOUNT-OUT":"Spent : ",
        "ZERO-REPORTS": "There is no transparency reports",
        "DELETED": "This Profile is close"
    },
    "MONTH": {
        "JAN": "January",
        "FEB": "February",
    ...
    "BUTTONS": {
      ...
      "DONOR-PROFILE": {
    	...
    	"PORTFOLIO-EMPTY": "The Portfolio is currently empty",
    	"TITLE": "Bill Report",
    ...
    "TRANSPARENCY-REPORT":{ 
        ...
        "TOTAL-AMOUNT-OUT": "Total amount out: ",
        "NOT-SPECIFIED": "Haven't been specified: ",
        "OVERDRAFT": "Overdraft: "                  
    },
     "LISTCAMPAIGN":{
    	...
    	"ZERO":"You still haven't created a campaign."
    },
    ...
    "FEEDBACK-MODAL":{
    	...
    	"ERROR-400-TEXT": "Bad Request",
    	"ERROR-401-TEXT": "Unauthorized Request",  
    	"ERROR-408-TEXT": "Request Timeout",    
    	"ERROR-404-TEXT": "Page Not Found",    
    	"ERROR-520-TEXT": "Unknown Error",
    	"ERROR-10-TEXT": "Data Base Unknown Error",
    	"GENERAL-TITLE": "Error"
    },
    "DONATION":{
